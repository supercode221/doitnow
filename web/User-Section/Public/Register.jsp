            ...
            <div class="main">
                <div class="information-section">
                    <div class="register-section">
                        <p style="font-weight: bold; font-size: 31px; margin-bottom: 20px;">Sign up<p>
                    ...
                    <div class="divide"></div>
                    <p style="text-align: center; font-size: 14px;">Already signed up? <a href="login" style="text-decoration: underline;">Go to login</a></p>
                </div>
                <div class="images">
                    <div class="up">
                        <div class="img">
